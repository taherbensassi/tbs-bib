...
class ResetPasswordController extends AbstractController
{
    ...
    public function checkEmail(): Response
    {
        ...
        return $this->render('Security/Reset/check_email.html.twig', [
    ...
    public function reset(Request $request, UserPasswordEncoderInterface $passwordEncoder, string $token = null, TranslatorInterface $translator): Response
    {
        ...
        if (null === $token) {
            throw $this->createNotFoundException($translator->trans('backend.reset.tokem'));
        }
        ...
        try {
            ...
            $this->addFlash(
                ...
                $translator->trans('backend.reset.error')
            );
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ...
            ->htmlTemplate('Mail/Security/Reset/email.html.twig')
            ->context([
                'resetToken' => $resetToken,
            ])
        ;
